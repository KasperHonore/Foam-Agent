<!-- GENERATED by scripts/sync_agent_assets.py from agents/skills/foam/references/openfoam-v10-conventions.md — edit the source and re-run the script; do not edit this copy. -->
